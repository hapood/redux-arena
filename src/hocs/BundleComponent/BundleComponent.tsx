...
import { BundleComponentConnectedProps, BundleComponentProps, BundleComponentState } from "./types"
...
> {
    ...
    getChildContext() {
        return {
            arenaReducerDict: this.props.reduxInfo && this.props.reduxInfo.arenaReducerDict
        }
    }
