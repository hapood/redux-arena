import { AnyAction, Dispatch, ActionCreatorsMapObject, ActionCreator } from "redux"
...
export default function bindArenaActionCreators<M extends ActionCreatorsMapObject>(
    ...
    if (
        ...
        throw new Error(
            `bindArenaActionCreators expected an object, instead received ${actionCreators === null
                ? "null"
